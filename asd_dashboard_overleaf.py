...
movement_values = [18, 7, 4, 3, 3, 2]

# B. Methodological approach
# IMPORTANT: corrected total = 37
method_labels = [
...
learning_values = [34, 1, 2]

# Performance
performance_labels = ["< 80%", "80–89%", "90–94%", "≥ 95%"]
performance_counts = [4, 9, 6, 14]
performance_pct = [12.1, 27.3, 18.2, 42.4]
...
add_header(
    ax_left,
    "1. OVERVIEW BY STUDY CHARACTERISTICS (n = 37)",
    DARK_BLUE
)
...
ax_right.text(
    0.225,
    0.085,
    "Nearly half of the studies (42.4%) report high\n"
    "performance (≥95% accuracy), highlighting the\n"
...
plt.savefig(
    "asd_dashboard_overleaf.pdf",
    bbox_inches="tight",
    dpi=300
)

plt.savefig(
    "asd_dashboard_overleaf.png",
    bbox_inches="tight",
    dpi=300
)