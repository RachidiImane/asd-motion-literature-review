...
def donut_with_callouts(
    ...
    for i, (wedge, value) in enumerate(zip(wedges, values)):
        ...
        # ----------------------------------------------------
            ...
            radius = 0.79
            percentage_fontsize = 9 if percentage <= 6.0 else 11
...
add_header(
    ax_left,
    "OVERVIEW BY STUDY CHARACTERISTICS (n = 36)",
    DARK_BLUE
)
...
plt.savefig(
    "/Users/imanerachidi/Downloads/asd_study_characteristics.pdf",
    bbox_inches="tight",
    dpi=300
)

plt.savefig(
    "/Users/imanerachidi/Downloads/asd_study_characteristics.png",
    bbox_inches="tight",
    dpi=300
)
